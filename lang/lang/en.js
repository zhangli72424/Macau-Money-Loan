export default {
	...
	pppp2:'Thank you for choosing Money loan service. This service is owned and operated by Money loan.',
	pppp3:'The "Money loan Service Agreement" (hereinafter referred to as the "Agreement") is signed byMoney loan and you (hereinafter referred to as the "User"), and this agreement has the contractual legal effect between you and the Company. In this agreement:',
	...
	pppp6:'We hereby remind you that you are using ourMoney loan mobile application (hereinafter referred to as "Money loan" or "this software",Money loan can be downloaded and installed through a fixed download link. Please read this agreement and the related documents mentioned later in this article carefully. The agreement, especially the clauses in the form of "exemption and limitation of liability" in bold, ensure that you fully understand the terms of this agreement and consider the risks on your own.',
	pppp7:'I. Confirmation and acceptance of this agreement',
	pppp8:'1You understand that this agreement and related agreements apply to the decentralized and centralized services independently developed and owned by the company onMoney loan andMoney loan.',
	pppp9:'2 By downloading theMoney loan software and registering as our user, it is deemed that you have fully read and accepted all the terms of this agreement, this agreement takes effect immediately and is binding on both parties. If you do not agree with the terms of this agreement, you should immediately stop usingMoney loan. If you have downloadedMoney loan, delete it now.',
	pppp10:'3When visiting or usingMoney loan you agree:',
	pppp11:'1 Subject to the latest version of this agreement (no change or modification);',
	pppp12:'2 In your applicable jurisdiction, you have reached the legal age to useMoney loan and can assume binding legal or monetary obligations arising from the use ofMoney loan;',
	pppp13:'3 You are not an excluded person (as defined in this agreement).',
	pppp14:'4. This agreement can be updated by us at any time. Once the revised agreement is published onMoney loan, it will automatically take effect immediately without further notice. After the company announces the revised agreement terms, if you do not accept the revised terms, please stop usingMoney loan immediately. Your continued use ofMoney loan will be deemed to accept the revised agreement.',
	pppp15:'Definition',
	pppp16:'1.Money loan: refers to financial products developed by the company based on the blockchain, includingMoney loan wallet, cloud wallet, asset statistics, video courses, asset trading, investment, etc.',
	...
	pppp21:'4Money loan wallet: The private key is stored in the user\'s mobile phone, which is 100% owned by the user.',
	...
	pppp24:'7Creating or importing a wallet: means the process of creating or importing a wallet usingMoney loan after you accept this agreement.',
	pppp25:'8Wallet password: Refers to the password you decide during the creation of theMoney loan wallet. This password will be used to encrypt and protect your private key.',
	pppp26:'9 Digital Token: Refers to the types of digital tokens currently supported byMoney loan, including but not limited to BTC, ETH, USDT, etc.',
	pppp27:'10. Freezing: The borrower deposits digital currency on theMoney loan platform as a transaction guarantee. When the transaction is completed, the digital currency will be dealt with by the counterparty.',
	...
	pppp30:'13 Video course: refers to the audio and video and text files produced byMoney loan and provided to users for learning and viewing, including but not limited to video files and graphic file text files.',
	pppp31:'14 Encrypted chat: refers to the instant chat tool developed byMoney loan based on elliptic curve encryption technology for users to use.',
	pppp32:'15 Ordinary chat: refers to the instant chat tool developed byMoney loan for users.',
	pppp33:'16T2T: refers to the functional block of digital currency exchange developed byMoney loan and provided to users. At the same time, it must comply with the "Money loan Anti-Money Laundering and Anti-Terrorist Financing User Guide" and "Transaction Security Agreement".',
	pppp34:'17OTC: Refers to the functional block developed byMoney loan and provided for users to purchase digital currency. At the same time, it is necessary to abide by the "Money loan Anti-Money Laundering and Anti-Terrorist Financing User Guide" and the "Transaction Security Agreement".',
	pppp35:'License',
	pppp36:'Subject to your compliance with this agreement,Money loan grants you limited rights to useMoney loan and related services. This right of use is granted to you personally, with restrictions, is non-exclusive, non-transferable,Money loan has the right to revoke this authorization, and you must comply with all the terms of this agreement. Your license does not represent your ownership ofMoney loan or related services. When you violate any of the terms of this agreement,Money loan has the right to suspend, change, interrupt, restrict, or even terminate the services provided to you. When you change, interrupt or terminate the service relationship betweenMoney loan. You still have the right to export your wallet information within a reasonable time.',
	pppp37:'Fourth, service content',
	pppp38:'1 Create and restore wallets. You can use the "Create Wallet" and "Restore Wallet" provided byMoney loan to create and restore wallets. For digital tokens supported byMoney loan, you can useMoney loan to generate new wallets or import other wallets of related blockchain systems. A compatible wallet generated by the tool.',
	pppp39:'2Transfer and receive money. You can useMoney loan\'s transfer and collection functions to manage digital tokens, that is, use private keys for electronic signatures and modify the books of the relevant blockchain. Transfer means that the payer uses the recipient\'s blockchain address to perform the transfer operation. The "transfer" behavior involves a valid record of the transaction in the distributed ledger of the relevant blockchain system (rather than the actual delivery onMoney loan Or transfer digital tokens).',
	...
	pppp41:'4. Cloud wallet. You can openMoney loan cloud wallet. After opening this service, it will be deemed that you will entrust some digital tokens toMoney loan for management.',
	pppp42:'5 asset statistics. You can use the asset statistics service to help you calculate the cost profit and loss of multiple channels after opening theMoney loan wallet and cloud wallet in the binding exchange.',
	pppp43:'6 T2T. You can exchange digital currency with otherMoney loan users through the T2T function.',
	pppp44:'7 OTC. You can make digital currency transactions with otherMoney loan users through the OTC function.',
	pppp45:'8 encrypted chat. You can use the encrypted chat function for instant communication with otherMoney loan users.',
	pppp46:'9 ordinary chat. You can chat with otherMoney loan users instantly through the chat function.',
	pppp47:'10 video tutorials. You can watch videos, text files, including but not limited to video files, graphic files, text files, provided byMoney loan for users to learn and communicate.',
	pppp48:'11For all the above services,Money loan is entitled to charge a certain service fee. Specific fees refer to the rates published byMoney loan.',
	pppp49:'V. Risk Tips',
	pppp50:'You understand and understand that because the laws and regulations in the digital token field have not yet been perfected, digital tokens in this field may have major risks such as unrealization, technical instability, etc. You also know that the price of digital tokens fluctuates much more than other financial assets. We caution you that you should choose to hold or dispose of any digital token in a reasonable manner based on your financial situation and risk appetite. You also understand that the market viewing function provided byMoney loan is only a search result that captures the digital token exchange rate information of some exchanges, and is not meant to be the latest market or the best quote. For your use ofMoney loan, you will bear all the consequences of operating onMoney loan. In addition to this reminder, your use ofMoney loan means that you have read and accepted the relevant Risk disclosure statement.',
	pppp51:'Six, your rights and obligations',
	pppp52:'1Create or import wallet: You have the right to create and / or import a wallet throughMoney loan on your mobile device, the right to set the wallet password and other information, and the right to use your own wallet through theMoney loan app Transactions such as transfers and receipts are performed on the blockchain.',
	pppp53:'2 User authentication: According to the requirements of relevant laws and regulations, when using specific services provided byMoney loan, specific users should complete the relevant identity verification promptly according toMoney loan\'s prompts, and require you to submit including but not limited to your name, ID number, Personal information such as mobile phone numbers and bank card numbers. Otherwise, the specific user will not be able to use the service, and you will be responsible for the losses caused by the delay of the specific user.',
	pppp54:'3 Collection and transfer: You know that the daily transfer limit and number of transactions that you can use in theMoney loan service may be due to the country / region where you use the transfer service, regulatory requirements, transfer purpose,Money loan risk control , Authentication, etc. You understand the "non-sale" attribute based on blockchain operations. When you use theMoney loan transfer function, you should bear the consequences caused by your operation mistakes (including but not limited to your wrong transfer address, your own The problem of selecting the transfer node server).',
	pppp55:'4 Legal compliance: You know that whenMoney loan is operating or using smart contracts onMoney loan for transactions, you should follow the requirements of relevant laws and regulations and national policies.',
	...
	pppp59:'1. You understand and agree that the company may, at its discretion, temporarily provide some service functions, or suspend some service functions or open new service functions in the future. When we change the service, as long as you still useMoney loan, you still agree to this agreement or the amended terms of this agreement.',
	pppp60:'2 In order to avoid as far as possible any misoperation ofMoney loan or any security risk of digital tokens, you should avoid usingMoney loan without the basic knowledge of blockchain. For users who do not have the basic knowledge of the blockchain, the company has the right to refuse to provide some or all of the service functions.',
	...
	pppp62:'1. Interruption ofMoney loan\'s operations due to technical reasons such as equipment, blockchain system maintenance, upgrades, failures and communication interruptions;',
	...
	pppp66:'4 The company may unilaterally suspend or terminate the user\'s use of some or all ofMoney loan\'s functions when the user has the following conditions:',
	pppp67:'1.The user died;',
	pppp68:'2 misappropriation of other people\'s wallet information or mobile devices;',
	pppp69:'3 Fill in false personal information inMoney loan;',
	pppp70:'4 Reject the forced update operation ofMoney loan;',
	pppp71:'5 UseMoney loan for illegal or criminal activities;',
	pppp72:'6 prevent other users from usingMoney loan normally;',
	...
	pppp75:'9 UseMoney loan to promote spam ads;',
	pppp76:'10 spread rumors, damage the goodwill of the company andMoney loan;',
	...
	pppp80:'1. You shall abide by the laws and regulations of the country or region where you live, and shall not useMoney loan for any illegal purpose or useMoney loan in any illegal way.',
	pppp81:'2 You must not useMoney loan to engage in any illegal or criminal behavior, including but not limited to:',
	...
	pppp86:'5 Invade othersMoney loan wallet to steal digital tokens;',
	...
	pppp88:'7. Engage in any behavior that infringes or may infringeMoney loan service system and data;',
	...
	pppp93:'Any data or information you provide to us is also subject to our privacy policy "Money loan Privacy Policy", which is also part of this agreement.',
	...
	pppp96:'2. You understand and agree that, to the maximum extent permitted by law, the company can only provideMoney loan services in accordance with existing technology levels and conditions. The company is not responsible forMoney loan\'s failure to provide services due to any of the following reasons:',
	pppp97:'1.Money loan system shutdown maintenance or upgrade;',
	...
	pppp104:'1 The user\'s digital token is lost because you lost your mobile device, deleted and not backed upMoney loan, deleted and not backed up the wallet, forgotten and not backed up the wallet password, mnemonics',
	pppp105:'2.Because you disclosed your wallet password, mnemonic, or borrowed, transferred or authorized others to use your mobile device orMoney loan wallet, or did not download theMoney loan app through our official channels or used it in other insecure ways Loss of your digital tokens caused by theMoney loan app;',
	...
	pppp111:'1Intellectual Property StatementMoney loan is an application developed and owned by our company. The intellectual property of any content displayed inMoney loan (including this agreement, announcement, article, video, audio, picture, file, information, material, trademark or logo) is owned by the company or third party rights holders. Users may use theMoney loan app and its contents only for the purpose of holding and managing digital tokens. Without the prior written consent of the company or third party rights holders, no one may use, modify, reverse compile, copy, publicly disseminate, change, distribute, distribute or publicly release the above-mentioned applications and contents without prior written consent. This agreement should not be construed as granting you any intellectual property rights, including the right to use any information, pictures, user interfaces, logos, trademarks, trade names, web domain names, or copyrights related to us or the service for any purpose.',
	...
	pppp115:'2.3 Maintaining software security and normal use is a joint responsibility ofMoney loan and you.Money loan will reasonably and prudently take necessary technical measures to protect your terminal device information and data in accordance with industry standards, but you acknowledge and agree thatMoney loan cannot provide this. Full guarantee.',
	...
	Language_type:{
		...
		update_tip: "The Money loan has been released in a new version. Are you updating?",
		isJumping: "Jumping...",
		...
		Snapped_up:"Snapped up",
		total_amount:"total amount",
		Remaining_copies:"Remaining copies",
		Buy_it_now:"Buy it now",
		Converted:"Converted",
		Limited_quantity:"Limited quantity",
		home_purchase_restrictions:"restrictions",
		count_down:"count down",
		Select_copies_number:"Select number",
		share:"share",
		assets:"assets",
